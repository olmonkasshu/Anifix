    ...
    return (
      <div>
        ...
        <div className="flex overflow-x-auto">
          <div className="relative w-52 h-auto m-5">
            <img src="src/assets/Poster/1c75ea35d5368be9d117157bf03e03a2_fd5322fc766949a29378bf63fe4036f4.jpg" alt="" />
            <div className="absolute bottom-0 left-0 right-0 bg-red-700 opacity-50 p-2">
          ...
          <div className="relative w-52 h-auto m-5">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-red-700 opacity-50 p-2">
              <h1 className="text-white font-extrabold z-10 text-xs">Hunter X Hunters</h1>
            </div>
          </div>
